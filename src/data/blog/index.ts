...
const blogData = createLocalizedData({
  zh: [
...
export const getBlogPosts = blogData.getItems;
export const getBlogPostMap = (locale?: string) => blogData.getItemMap(locale, (p: any) => p.slug);

/** 兼容旧直接引用：默认中文 */
export const BLOG_POSTS = blogData.defaultItems;
export const BLOG_POST_MAP = blogData.getItemMap(undefined, (p: any) => p.slug);
