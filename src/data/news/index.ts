...
export function getNewsArticles(locale?: string) {
  if (locale === 'en') return NEWS_FALLBACK_EN;
  return NEWS_FALLBACK_ZH;
}

/** 兼容旧直接引用：默认中文 */
export const NEWS_FALLBACK = NEWS_FALLBACK_ZH;
