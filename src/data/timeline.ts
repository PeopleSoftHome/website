...
const TIMELINE_ZH = [
  ...
  { year: '2021', title: 'AI 实验室成立', desc: '成立 AI 实验室，启动 AI 招聘助手、智能排班等前沿项目研发。' },
  { year: '2022', title: 'B 轮融资', desc: '完成 1.5 亿元 B 轮融资，客户突破 2000 家，启动全球化战略。' },
  { year: '2023', title: 'AI Family 发布', desc: 'AI Family 1.0 正式发布，涵盖 AI 招聘、AI 面试、AI 教练等 6 大 AI 助手。' },
  { year: '2024', title: '等保三级认证', desc: '通过国家信息安全等级保护三级认证，安全合规能力达到金融级标准。' },
