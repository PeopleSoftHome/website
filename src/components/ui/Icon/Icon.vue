<template>
  ...
  >
    ...
    <template v-else-if="name === 'store'">
      <path d="M3 21h18M5 21V7l8-4 8 4v14M8 21V11h8v10" />
      <path d="M10 7h4" />
    </template>
    ...
    <template v-else-if="name === 'landmark'">
      <path d="M3 22h18M6 18v-7l6-4 6 4v7M12 7V3" />
      <path d="M6 18h12" />
    </template>
    ...
    <template v-else-if="name === 'bank'">
      ...
      <polyline points="2 22 12 17 22 22" />
    </template>
    ...
    <template v-else-if="name === 'gem'">
      ...
      <path d="M12 22V9M2 9h20M7.5 3 12 9l4.5-6" />
    </template>
    ...
    <!-- default fallback: question mark -->
    <template v-else>
      <circle cx="12" cy="12" r="10" />
      <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
      <line x1="12" y1="17" x2="12.01" y2="17" />
